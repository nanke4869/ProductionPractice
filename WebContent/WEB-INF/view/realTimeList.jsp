...
<head>
	...
	$(function() {	
		...
		//datagrid初始化 
	    $('#dataList').datagrid({ 
	        title:'设备ID-21:00:00:21:21:66', 
	        iconCls:'icon-more',//图标 
	        border: true, 
	        collapsible:false,//是否可折叠的 
	        fit: true,//自动大小 
	        method: "post",
	        url:"RealTimeServlet?method=getRealTimeList&t="+new Date().getTime(),
	        idField:'id', 
	        ...
	        remoteSort: false,
	        columns: [[  
 		        {field:'indoorTemp',title:'温度',width:50, sortable: true},    
 		        {field:'noise',title:'噪声',width:50},    
 		        {field:'aphaseVolt',title:'A相电压',width:50},
 		        {field:'bphaseVolt',title:'B相电压',width:50},
 		        {field:'cphaseVolt',title:'C相电压',width:50},
 		        {field:'ABphaseVolt',title:'AB相电压',width:50},
 		        {field:'BCphaseVolt',title:'BC相电压',width:50},
 		        {field:'ACphaseVolt',title:'AC相电压',width:50},
 		        {field:'aphaseCurrent',title:'A相电流',width:50},
 		        {field:'bphaseCurrent',title:'B相电流',width:50},
 		        {field:'cphaseCurrent',title:'C相电流',width:50},
 		        {field:'threephaseCurrentSum',title:'三相电流矢量和',width:50},
 		        {field:'aphaseHasPower',title:'A相有功功率',width:50},
 		        {field:'bphaseHasPower',title:'B相有功功率',width:50},
 		        {field:'cphaseHasPower',title:'C相有功功率',width:50},
 		        {field:'totalActivePower',title:'总有功功率',width:50},
 		        {field:'aphaseReactivePower',title:'A相无功功率',width:50},
 		        {field:'bphaseReactivePower',title:'B相无功功率',width:50},
 		        {field:'cphaseReactivePower',title:'C相无功功率',width:50},
 		        {field:'totalReactivePower',title:'总无功功率',width:50},
 		        {field:'phaseAPowerFactor',title:'A相功率因素',width:50},
 		        {field:'phaseBPowerFactor',title:'B相功率因素',width:50},
 		        {field:'phaseCPowerFactor',title:'C相功率因素',width:50},
 		        {field:'totalPowerFactor',title:'总功率因素',width:50},
 		        {field:'powerFrequency',title:'电源频率',width:50},
 		        {field:'phaseATotalElectConsump',title:'A相总用电量',width:50},
 		        {field:'phaseBTotalElectConsump',title:'B相总用电量',width:50},
 		        {field:'phaseCTotalElectConsump',title:'C相总用电量',width:50},
 		        {field:'totalElectrConsump',title:'总用电量',width:50},
 		        {field:'NBSignalStrength',title:'NB信号强度',width:50},
 		        {field:'aphaseLineTemp',title:'A相线温度',width:50},
 		        {field:'bphaseLineTemp',title:'B相线温度',width:50},
 		        {field:'cphaseLineTemp',title:'C相线温度',width:50},
	 		]],
	        toolbar: "#toolbar"
	    });  
	    //设置分页控件 
