...
<head>
	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        fit: true,//自动大小 
	        method: "post",
	        url:"DeviceServlet?method=getDeviceList&t="+new Date().getTime(),
	        idField:'id', 
	        ...
	        columns: [[  
				{field:'chk',checkbox: true,width:50},
 		        {field:'devID',title:'设备ID',width:140, sortable: true},    
 		        ...
 		        {field:'online',title:'在线状态',width:100, 
 		        	formatter: function(value,row,index){
 						if (row.status){
 		        ...
 		        {field:'locationName',title:'单位名称',width:100, 
 		        	formatter: function(value,row,index){
 						if (row.status){
 							return row.status.name;
 						} else {
 		        ...
 		        {field:'latitude',title:'维度',width:100},
 		        {field:'create_date',title:'建档日期',width:150, sortable: true},
	 		]],
	        toolbar: "#toolbar"
	    });  
	    //设置分页控件 
